...
module.exports = {
  site: {
    ...
    // Site endpoints
    backend: {
      productionUrl: "http://localhost:5000", //localhost do http://localhost:5000 // else "https://api.fortunebets.xyz"
      developmentUrl: "http://localhost:5000",
    },
    frontend: {
      productionUrl: "http://localhost:3000", //localhost do http://localhost:3000 // else "https://fortunebets.xyz"
      developmentUrl: "http://localhost:3000",
    },
    adminFrontend: {
      productionUrl: "https://admin.fortunebets.xyz",
      developmentUrl: "",
    },
  },
  database: {
    developmentMongoURI: "", // MongoURI to use in development
    productionMongoURI: "mongodb://localhost/fortunebets-xyz", // MongoURI to use in production
  },
  ...
  authentication: {
    ...
    reCaptcha: {
      secretKey: "6LcWZY8iAAAAADarIi3jAo-rjOxIJFNVBG-Ol0w1", //localhost do 6LcWZY8iAAAAADarIi3jAo-rjOxIJFNVBG-Ol0w1 //fortunebets do 6Lepd2UjAAAAAKMgTRyE7-AFOPkzvD6XhiA4d4VE
    },
    googleOauth: {
      clientId:
        "1050954520208-di3svepn2ier9blvb33urk62bg63easo.apps.googleusercontent.com", //if domain is fortunebets.xyz leave as it is
      clientSecret: "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", //if domain is fortunebets.xyz leave as it is
    },
    steam: {
      apiKey: "D133223AE8BC559B71F0EF7CFA01F2AB", // Your Steam API key //if domain is fortunebets.xyz leave as it is //for localhost need probably localhost apikey
    },
  },
};
