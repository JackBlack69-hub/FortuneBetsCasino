...
let transporter = nodemailer.createTransport({
  ...
  secure: true,
  auth: {
    user: "rakeclubinfo@gmail.com",
    pass: "byaoyixegmmlfgvf",
  },
});
  ...
  router.post("/forgot_password", async (req, res, next) => {
    try {
      ...
      let info = await transporter.sendMail({
        from: '"fortunebets.xyz" <noreplyfortunebetsxyz@gmail.com>',
        to: req.body.email,
        subject: "Security Token",
        html: `
          <div style="font-size: 18px;">
            <div>You requested a password reset on your fortunebets.xyz account.</div>
            <br/>
