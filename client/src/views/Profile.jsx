        ...
        <Container maxWidth="lg">
          <Grow in timeout={620}>
            <Box className={classes.profile}>
              ...
              <h1 style={{ marginLeft: "5px", }}>Profile <span style={{ color: "#2196f3", fontSize: "16px", }}>{user._id}</span></h1>
              <Box className={classes.userWrap} style={{ backgroundColor: "#0F1519", }}>
                <Box className={classes.user}>
                  ...
                  <Box>
                    <Button disableRipple onClick={changeAvatar} className={classes.buttontes} variant="contained" style={{ fontFamily: "Rubik", background: `${vipDataColor}`, fontSize: "13px", }}>CHANGE AVATAR</Button>
                  </Box>
                  ...
                  <br />
                  <h5 style={{ textTransform: "inherit", marginBottom: "25px", marginLeft: "1px", }}>Member since {parseDate1(user.created)}</h5>
