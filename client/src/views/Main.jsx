...
import fortunebetsbanner from "../assets/jackpotbanner.png";
...
const useStyles = makeStyles(theme => ({
  ...
  reward: {
    ...
    textAlign: "center",
    position: "relative",
    background: "linear-gradient(180deg,#12191D,#11161c)",
    borderRadius: "10px",
    transition: ".2s",
    WebkitUserSelect: "none",
    MozUserSelect: "none",
    ...
    <Box className={classes.root}>
      ...
      <Grow in timeout={430}>
        <Container className={classes.container}>
          ...
          />
          <TriviaInfo
            handleClose={() => setOpenTriviaInfo(!openTriviaInfo)}
            open={openTriviaInfo}
          />
          <RainInfo
            handleClose={() => setOpenRainInfo(!openRainInfo)}
            open={openRainInfo}
          />
          <Box className={classes.animationnetworkwrapper1}>
            <p>
              <span className={classes.animationnetworkwrapper}>
                <span className={classes.animationnetwork}>●</span>
              </span>{" "}
              {usersOnline}
            </p>
          </Box>
            ...
            {isLoading ? (
              ...
              <Box className={classes.headerright}>
                <Box className={classes.headerbuttons}>
                  ...
                  >
                    <button className={classes.headerbuttonsDep}>
                      <span className={classes.headerbuttonsDepSpan}>
                        <span
                          aria-label="Tray Plus icon"
                          role="img"
                          className="material-design-icon tray-plus-icon"
                        >
                          <svg
                            data-v-8351ef5e=""
                            data-v-98afd824=""
                          ...
                          >
                            ...
                            >
                              <title data-v-8351ef5e="" data-v-98afd824="">
                                Tray Plus icon
                              </title>
                            </path>
                          </svg>
                  ...
                  >
                    <button className={classes.headerbuttonsWith}>
                      <span className={classes.headerbuttonsWithSpan}>
                        <span
                          aria-label="Tray Minus icon"
                          role="img"
                          className="material-design-icon tray-minus-icon"
                        >
                          <svg
                            fill="currentColor"
                            width="24"
                    ...
                    {loading ? (
                      ...
                      <Box
                        ...
                        style={{
                          width: "40px",
                          height: "40px",
                          background: `${vipDataColor}`,
                        }}
                      >
                        <Box className={classes.avatarimg}>
                          <img
                            className={classes.avatarimg2}
                            alt="Avatar"
                            src={user.avatar}
                          />
                        </Box>
              ...
              <Box className={classes.headerright}>
                <Box className={classes.headerbuttons}>
                  <Link
                    ...
                    style={{ textDecoration: "none", outline: "none" }}
                  >
                    <button className={classes.headerbuttonsLogin}>
                      <span className={classes.headerbuttonsDepSpan}>
                        <span
                          aria-label="Tray Plus icon"
                          role="img"
          ...
          {isLoading ? (
            ...
            <Carousel
              ...
              prevIcon={
                ...
                >
                  <path
                    d="M2.31 33a8 8 0 010-8l9.88-17.115a8 8 0 016.929-4H38.88a8 8 0 016.928 4L55.691 25a8 8 0 010 8l-9.882 17.115a8 8 0 01-6.928 4H19.12a8 8 0 01-6.928-4L2.309 33z"
                    fill="#5B6368"
                  ></path>
                  <path
                    data-v-1163a730=""
                    d="M31.762 35.339l-2.102 1.947L20.714 29l8.946-8.286 2.102 1.947L24.934 29l6.828 6.339z"
                    fill="#fff"
                  ></path>
                  <path
                    data-v-1163a730=""
                    d="M23.476 27.62h13.81v2.761h-13.81v-2.762z"
                    fill="#fff"
                  ></path>
                </svg>
              }
          ...
          <Box
            style={{
              borderBottom: "1px solid rgb(51 59 66)",
              marginTop: "5px",
              marginBottom: "10px",
            }}
          ></Box>
          ...
          <Box className={classes.rewards}>
            {isAuthenticated && user ? (
              ...
              >
                <button className={classes.reward}>
                  <span
                    aria-label="Brightness Percent icon"
                    role="img"
                    className="material-design-icon brightness-percent-icon bonusPromotion icon"
                  >
                    <svg
                      data-v-c655217e=""
                      fill="currentColor"
            ...
            >
              <button className={classes.reward}>
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
                  className="svg-inline--fa fa-receipt fa-w-16 fa-fw"
                >
                  <path
                    fill="currentColor"
            ...
            {isAuthenticated && user ? (
              ...
              >
                <button className={classes.reward}>
                  <span
                    style={{ marginTop: "-3px" }}
                    aria-label="Chevron Double Up icon"
                    role="img"
                    className="material-design-icon chevron-double-up-icon levelRewards icon"
                  >
                    <svg
                      data-v-c655217e=""
                      fill="currentColor"
                    ...
                    >
                      ...
                      >
                        <title data-v-c655217e="">Chevron Double Up icon</title>
                      </path>
                    </svg>
                  </span>
                  <div
            ...
            {isAuthenticated && user ? (
              ...
              >
                <button className={classes.reward}>
                  <span
                    style={{ marginTop: "-3px" }}
                    aria-label="Package Variant Closed icon"
                    role="img"
                    className="material-design-icon package-variant-closed-icon dailyCase icon"
                  >
                    <svg
                      data-v-c655217e=""
                      fill="currentColor"
              ...
              >
                <button className={classes.reward}>
                  <span
                    ...
                    aria-label="Account Group icon"
                    role="img"
                    className="material-design-icon account-group-icon affiliates icon"
                  >
                    <svg
                      data-v-c655217e=""
                      fill="currentColor"
                    ...
                    >
                      ...
                      >
                        <title data-v-c655217e="">Account Group icon</title>
                      </path>
                    </svg>
                  </span>
                  <div
            ...
            >
              <button className={classes.reward}>
                <span
                  aria-label="Lightbulb On icon"
                  role="img"
                  className="material-design-icon lightbulb-on-icon trivia icon"
                >
                  <svg
                    data-v-c655217e=""
                    fill="currentColor"
                  ...
                  >
                    ...
                    >
                      <title data-v-c655217e="">Lightbulb On icon</title>
                    </path>
                  </svg>
                </span>
                <div
            ...
            >
              <button className={classes.reward}>
                <span
                  style={{ marginTop: "-4px" }}
                  aria-label="Wallet Giftcard icon"
                  role="img"
                  className="material-design-icon wallet-giftcard-icon sidebarGiveaway icon"
                >
                  <svg
                    data-v-c655217e=""
                    fill="currentColor"
                  ...
                  >
                    ...
                    >
                      <title data-v-c655217e="">Wallet Giftcard icon</title>
                    </path>
                  </svg>
                </span>
                <div
            ...
            <a
              ...
              href="https://twitter.com/fortunebetsxyz"
              target="_blank"
              rel="noreferrer"
              alt="Twitter"
            >
              <button className={classes.reward}>
                ...
                >
                  ...
                  >
                    <title data-v-17895ccb="" data-v-98afd824="">
                      Twitter icon
                    </title>
                  </path>
                </svg>
