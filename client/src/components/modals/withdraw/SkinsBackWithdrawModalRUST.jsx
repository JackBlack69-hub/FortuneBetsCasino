  ...
  return (
    ...
    >
      ...
      ><img style={{ width: "27px", height: "unset", marginRight: "10px", marginBottom: "-3px", }} width="26px" height="26px" src={rust} alt="Rust" />
        ...
        <br /><br />
        <div style={{ fontSize: "15px", fontFamily: "Rubik", fontWeight: 300, }}>Your balance <span style={{ fontSize: "15px", fontFamily: "Rubik", color: "#2196f3", fontWeight: 800, }}>$</span> <span style={{ fontWeight: 500, }}>{user.wallet.toFixed(2)}</span></div>
        <br />
      ...
      <DialogActions>
        <div className={classes.withdrawLeft}>
          <span style={{ fontSize: "15px", fontFamily: "Rubik", color: "#2196f3", fontWeight: 800, }}>$</span> {items.filter(item => item.selected).reduce((acc, item) => acc + item.price, 0).toFixed(2)} <br />
