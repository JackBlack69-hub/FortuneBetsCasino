    ...
    <Box>
      <Box className={classes.root}>
        <Container>
          ...
          <Box className={classes.list}>
            <Box>Help</Box>
            <Link href="https://discord.gg/MqS9crBBDe" target="blank_">
              Support
            </Link>
            ...
            <Box style={{ display: "block" }}>
              ...
              >
                ...
                >
                  <path
                    fill="#9293A6"
                    d="M28.945 32.043h-24c-2.208 0-4-1.861-4-4.154V4.196c0-2.293 1.792-4.154 4-4.154h24c2.208 0 4 1.86 4 4.154v23.693c0 2.293-1.792 4.154-4 4.154ZM13.233 25.1c7.544 0 11.672-6.497 11.672-12.122 0-.183 0-.366-.008-.548a8.545 8.545 0 0 0 2.048-2.21 8.076 8.076 0 0 1-2.36.672 4.262 4.262 0 0 0 1.808-2.36c-.792.491-1.672.84-2.608 1.031a4.025 4.025 0 0 0-2.992-1.346c-2.264 0-4.104 1.911-4.104 4.262 0 .333.04.657.104.973-3.408-.175-6.432-1.878-8.456-4.454a4.388 4.388 0 0 0-.552 2.144c0 1.479.728 2.783 1.824 3.547a4.033 4.033 0 0 1-1.856-.531v.058c0 2.06 1.416 3.789 3.288 4.179-.344.1-.704.15-1.08.15-.264 0-.52-.025-.768-.075.52 1.695 2.04 2.924 3.832 2.958a8.036 8.036 0 0 1-6.072 1.77 11.355 11.355 0 0 0 6.28 1.902Z"
                  ></path>
                </svg>
              </Link>
              <Link href="https://discord.gg/MqS9crBBDe" target="blank_">
      ...
      <Box className={classes.endRoot}>
        <Container>
          <Box className="left">
            <span>Copyright © {new Date().getFullYear()} Fortunebets.xyz</span>
